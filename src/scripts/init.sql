CREATE TABLE `leads` (
  `lead_id` VARCHAR(38) NOT NULL DEFAULT UUID(),
...
CREATE TABLE `roles` (
  `roles_id` VARCHAR(38) NOT NULL DEFAULT UUID(),
...
CREATE TABLE `users_integrations` (
  `user_integration_id` VARCHAR(38) NOT NULL DEFAULT UUID(),
...
CREATE TABLE `manager_employee` (
  `manager_employee_id` VARCHAR(38) NOT NULL DEFAULT UUID(),
...
INSERT INTO `roles` (`role_name`,`can_add_employee`,`can_create_lead`,`can_edit_lead`,`can_vinculate_lead`,`created_at`) VALUES ('manager',1,1,1,1,NOW())
INSERT INTO `roles` (`role_name`,`can_add_employee`,`can_create_lead`,`can_edit_lead`,`can_vinculate_lead`,`created_at`) VALUES ('employee',0,1,1,0,NOW())